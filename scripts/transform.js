// Array.from(getComputedStyle(temp3)).forEach((name) =>
//   console.log(`'${name}': '${getComputedStyle(temp3).getPropertyValue(name)}',`)
// );

const DEFAULT_CHROME_PROPERTIES = {
  ...
  'block-size': '140px',
  'border-block-end-color': 'rgb(27, 27, 27)',
  'border-block-end-style': 'none',
  'border-block-end-width': '0px',
  'border-block-start-color': 'rgb(27, 27, 27)',
  ...
  'border-inline-end-color': 'rgb(27, 27, 27)',
  'border-inline-end-style': 'none',
  'border-inline-end-width': '0px',
  'border-inline-start-color': 'rgb(27, 27, 27)',
  ...
  'column-count': 'auto',
  'column-gap': 'normal',
  'column-rule-color': 'rgb(27, 27, 27)',
  ...
  'text-emphasis-color': 'rgb(27, 27, 27)',
  ...
  '-webkit-text-fill-color': 'rgb(27, 27, 27)',
...
function getAppliedCSS(el) {
  ...
  return stylesArray
    .filter((key) => {
      const defaultValue = DEFAULT_CHROME_PROPERTIES[key];
